...
public class stu_s_markname extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stu_s_markname);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newIn =new Intent(stu_s_markname.this,tea_f_markadd.class);
    ...
    class list_name extends AsyncTask<String,String, JSONObject> {
        ...
        public void onPostExecute(JSONObject jsonObject) {
            ...
            adapter=new mark_list_adapter(stu_s_markname.this,list);
