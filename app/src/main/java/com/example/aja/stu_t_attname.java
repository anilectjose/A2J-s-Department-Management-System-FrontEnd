...
public class stu_t_attname extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stu_t_attname);

        ActionBar newbar=getSupportActionBar();
        assert newbar != null;
        newbar.setTitle("Third Year");

        BaseUrl=getResources().getString(R.string.Base_URL);
        RegUrl=BaseUrl+"thi_attendance_name.php";//of api
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newIn =new Intent(stu_t_attname.this,stu_t_attendance.class);
    ...
    class list_name extends AsyncTask<String,String, JSONObject> {
        ...
        public void onPostExecute(JSONObject jsonObject) {
            ...
            adapter=new attend_list_adapter(stu_t_attname.this,list);
