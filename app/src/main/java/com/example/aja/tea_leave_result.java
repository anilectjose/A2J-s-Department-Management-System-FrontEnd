...
public class tea_leave_result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tea_leave_result);
        ...
        RegUrl=BaseUrl+"tea_leave_result.php";//of api
    ...
    class list_leave extends AsyncTask<String,String, JSONObject> {
        ...
        public void onPostExecute(JSONObject jsonObject) {
            ...
            adapter=new leave_result_adapter(tea_leave_result.this,list);
