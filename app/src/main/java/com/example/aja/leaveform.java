...
public class leaveform extends AppCompatActivity {
    ...
    EditText edt_name,edt_year,edt_reg,edt_date,edt_days,edt_reason;
    String str_name,str_year,str_reg,str_date,str_days,str_reason;
    Button btn_leave;
    String BaseURL = "";
    TextView result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaseURL = getResources().getString(R.string.Base_URL)+"student_leaveform.php";
        ...
        result.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), stu_leave_result.class);
                startActivity(i);
            }
        });
        ...
        btn_leave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str_name.equals(""))
                {
                    Toast.makeText(leaveform.this, "Name is required", Toast.LENGTH_SHORT).show();
                }
                else if (str_year.equals(""))
                {
                    Toast.makeText(leaveform.this, "Year is required", Toast.LENGTH_SHORT).show();
                }
                else if (str_reg.equals(""))
                {
                    Toast.makeText(leaveform.this, "Reg no requied", Toast.LENGTH_SHORT).show();
                }
                else if (str_date.equals(""))
                {
                    Toast.makeText(leaveform.this, "Date is requied", Toast.LENGTH_SHORT).show();
                }
                else if(str_days.equals(""))
                {
                    Toast.makeText(leaveform.this, "Days requied", Toast.LENGTH_SHORT).show();
                }
                else if (str_reason.equals(""))
                {
                    Toast.makeText(leaveform.this, "Reason is requied", Toast.LENGTH_SHORT).show();
                }
                else
                {
