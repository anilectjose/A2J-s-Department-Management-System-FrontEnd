...
public class tea_second_attendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tea_second_attendance);
        ...
        BaseURL = getResources().getString(R.string.Base_URL)+"second_attendance_submit.php";
        ...
        if (str_mentor_cls.equals("1")||str_mentor_cls.equals("3")||str_mentor_cls.equals("")){
        ...
        btn_attend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (stot.equals(""))
                {
                    Toast.makeText(tea_second_attendance.this, "Total percentage is required", Toast.LENGTH_SHORT).show();
                }
                else
                {
