...
public class tea_s_mark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tea_s_mark);

        ActionBar newbar=getSupportActionBar();
        assert newbar != null;
        newbar.setTitle("Edit Intenal Marks");

        lv=(ListView)findViewById(R.id.tea_mark_list);

        RegUrl = getResources().getString(R.string.Base_URL)+"second_mark.php";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newIn =new Intent(tea_s_mark.this,tea_s_markadd.class);
                newIn.putExtra("stud_id", str_user_id);
                newIn.putExtra("year_value","2");
    ...
    class list_name extends AsyncTask<String,String, JSONObject> {
        ...
        public void onPostExecute(JSONObject jsonObject) {
            ...
            adapter=new mark_list_adapter(tea_s_mark.this,list);
