...
public class tea_f_mark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tea_f_mark);
        ...
        RegUrl = getResources().getString(R.string.Base_URL)+"first_mark.php";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newIn =new Intent(tea_f_mark.this,tea_f_markadd.class);
                newIn.putExtra("stud_id", str_user_id);
                newIn.putExtra("year_value","1");
    ...
    class list_name extends AsyncTask<String,String, JSONObject> {
        ...
        public void onPostExecute(JSONObject jsonObject) {
            ...
            adapter=new mark_list_adapter(tea_f_mark.this,list);
