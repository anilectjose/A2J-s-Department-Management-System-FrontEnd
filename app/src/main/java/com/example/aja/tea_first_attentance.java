...
public class tea_first_attentance extends AppCompatActivity {
    ...
    String str_stud_id,str_mentor_cls;
    SharedPreferences shp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tea_first_attentance);
        ...
        BaseURL = getResources().getString(R.string.Base_URL)+"first_attendance_submit.php";
        ...
        btn_attend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (stot.equals(""))
                {
                    Toast.makeText(tea_first_attentance.this, "Total percentage is required", Toast.LENGTH_SHORT).show();
                }
                else
                {
