...
public class tea_s_markadd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tea_s_markadd);
    ...
    private class GetMarkResult extends AsyncTask<String,String, JSONObject>
    {
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            adapter=new subject_list_adapter(tea_s_markadd.this,list);
            lv.setAdapter(adapter);
            adapter_2=new subject_list_adapter(tea_s_markadd.this,list2);
