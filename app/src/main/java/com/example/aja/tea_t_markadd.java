...
public class tea_t_markadd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tea_t_markadd);
    ...
    private class GetMarkResult extends AsyncTask<String,String, JSONObject>
    {
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            adapter=new subject_list_adapter(tea_t_markadd.this,list);
            lv.setAdapter(adapter);
            adapter_2=new subject_list_adapter(tea_t_markadd.this,list2);
